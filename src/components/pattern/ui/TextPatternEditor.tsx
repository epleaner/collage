...
export const TextPatternEditor = ({ layerId }: TextPatternEditorProps) => {
    ...
    const textContent = layer.textContent || 'TEXT';
    ...
    return (
        <div className="text-pattern-editor mt-4">
            <div className="mb-3">
            ...
            <div className="mb-3">
                <label className="block mb-1.5 text-white text-xs">Font Size ({textStyle.fontSize}px)</label>
                <input
                    type="range"
                    min="12"
                    max="500"
            ...
            <div className="mb-3">
                <label className="block mb-1.5 text-white text-xs">Line Height ({textStyle.lineHeight}×)</label>
                <input
                    type="range"
                    min="0.5"
                    max="3"
